        ...
        <div className="grid md:grid-cols-3 gap-10">
          <div className="py-[50px] px-[30px] rounded-md">
            <div className="flex items-center justify-center">
              <figure className="w-[100px] h-[100px] rounded-full border-2 border-solid border-BaseColor">
                <img
                  src={avatar}
                  alt=""
          ...
          <div className="col-span-2 md:px-[30px] ">
            <div className="flex">
              <button
                ...
                } p-2 mr-5 px-3 lg:px-5 rounded-md text-HeadingColor font-semibold text-[13px] md:text-[14px] lg:text-[16px] leading-7 border border-solid border-GrayColor`}
              >
                My Bookings
              </button>
              <button
