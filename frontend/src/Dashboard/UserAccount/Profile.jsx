      ...
      <form action="" onSubmit={submitHandler}>
        <div className="my-4">
          <input
            ...
            required
            className="w-full px-4 py-3 focus:outline-none border-b border-solid focus:border-b-BaseColor"
          />
        </div>
        <div className="my-4">
          <input
        ...
        <div className="mb-1 flex items-center gap-3">
          {user.photo && (
            <figure className="w-[45px] h-[45px] rounded-full border-2 border-solid border-BaseColor  flex items-center justify-center ">
