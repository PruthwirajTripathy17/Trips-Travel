...
const TourDetails = () => {
  ...
  return (
    <section className="my-4 px-4 md:px-12 w-full mx-auto max-w-7xl">
      <div>
        <div>
          <div className="flex flex-col md:flex-row gap-6">
            <div className="w-full md:w-2/3">
              <div className="max-w-full max-h-[500px] rounded-md overflow-hidden flex items-center justify-center">
                <img src={photo} alt={title} className="w-full object-cover rounded-md" />
              </div>
              <div className="my-8 overflow-hidden border-solid border-[2px] shadow-sm border-gray-200 rounded-md space-y-4 px-4 py-4 md:px-8 md:py-8 mx-auto">
              ...
              <div>
                ...
                <div>
                  {reviewsArray?.map((review, idx) => (
                    <div className="py-3 px-4 border-b border-gray-100 last:border-none" key={review._id || idx}>
                      <div className="flex items-center gap-4">
                        <div className="w-12 h-12 rounded-full border-gray-300 border-[1px] overflow-hidden">
                          <img src={avatar} alt="" />
                        </div>
                        <div>
                          <div>
            ...
            <div className="w-full md:w-1/3 px-4 md:px-6 rounded-md">
              <Booking
                title={title}
                price={price}
                avgRating={avgRating}
