      ...
      <div className="min-h-screen bg-cover md:pt-4 px-6 md:px-12 bg-center">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="gap-4 grid grid-cols-3 min-h-[200px]">
            <div className="rounded-lg my-8 overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-300">
              <img src={card01} className="object-cover h-full w-full transition-transform duration-300 hover:scale-105" alt="" />
            </div>

            <div className="rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-300">
              <img src={card02} className="object-cover h-full w-full transition-transform duration-300 hover:scale-105" alt="" />
            </div>

            <div className="rounded-lg my-8 overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-300">
              <img src={card03} className="object-cover h-full w-full transition-transform duration-300 hover:scale-105" alt="" />
            </div>
          </div>
        </div>
        <SearchBar />
