...
const TourCard = ({ tour }) => {
  ...
  return (
    <div className="group max-w-sm rounded-xl overflow-hidden shadow-lg hover:shadow-2xl h-[420px] flex flex-col transition-all duration-300 hover:-translate-y-1 bg-white border border-gray-100">
      <div className="relative overflow-hidden h-52">
        <img className="w-full h-full object-cover transform transition-transform duration-500 group-hover:scale-105" src={photo} alt={title} />
        {featured === true ? (
